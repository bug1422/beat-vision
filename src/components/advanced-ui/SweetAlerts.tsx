              ...
              <tbody>
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-pink"></i>A basic message
                  </td>
                  <td className="border-0">
                    <Button
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-success"></i>A title with a text
                    under
                  </td>
                  <td className="border-0">
                    <Button
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-warning"></i>A modal with a
                    title, an error icon, a text, and a footer
                  </td>
                  <td className="border-0">
                    <Button
                      variant="outline-primary"
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-pink"></i>A dialog with three
                    buttons
                  </td>
                  <td className="border-0">
                    <Button
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-info"></i>A custom positioned
                    dialog
                  </td>
                  <td className="border-0">
                    <Button
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-secondary"></i>A confirm dialog,
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-purple"></i>A message with a
                    custom image
                  </td>
                  <td className="border-0">
                    <Button
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-success"></i>A message with
                    custom width, padding, background and animated Nyan Cat
                  </td>
                  <td className="border-0">
                    <Button
                      variant="outline-primary"
                ...
                <tr className="border-0">
                  <td className="border-0">
                    <i className="mdi mdi-circle-outline me-1 text-warning"></i>A message with auto
                    close timer
                  </td>
                  <td className="border-0">
                    <Button
